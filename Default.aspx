...
<script language="C#" runat="server" >        
    ...
    void SetNewDate(Object sender, EventArgs e)
    {
        ...
        DateTime dateMin = DateTime.Now.AddHours(6);
        DateTime dateMax = DateTime.Now.AddMonths(11).AddDays(-5).AddHours(17);

        if (newDate < dateMin)
        {
            MessageBox("The chosen day: " + newDate.ToShortDateString() + "\\n" + 
    ...
    // 4, A li-ben a dátumok a default date-ek legyenek
    // 5, SetNewDate-ben a datemin és datemax pontosítása időzónákra
